...
export default function UploadSignstmm() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/upload-signstmm', {
        method: 'POST',
        body: formData,
      });
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">
            อัปโหลดข้อมูล SIGNSTMM
          </h1>
          <p className="text-gray-600">
            อัปโหลดไฟล์ XML สำหรับข้อมูลการชำระเงินผู้ป่วยใน
          </p>
        </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">ข้อมูล SIGNSTMM</h3>
          <div className="text-sm text-gray-600 space-y-2">
            <p><strong>ประเภทข้อมูล:</strong> ข้อมูลการชำระเงินผู้ป่วยใน</p>
