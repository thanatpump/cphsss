      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">ระบบจัดการข้อมูล SSO</p>
            <p className="mt-2 text-sm text-blue-700">
              รหัสผู้ใช้และรหัสผ่านใช้รหัสเดียวกับเว็ปประกันสังคม
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
